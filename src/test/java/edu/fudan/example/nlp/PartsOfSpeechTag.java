...
public class PartsOfSpeechTag {
	...
	public static void main(String[] args) throws Exception {
		...
		tag = new POSTagger(cws2, "models/pos.m"
				, new Dictionary("./models/dict_pos.txt"), true);//true就替换了之前的dict.txt
		tag.removeDictionary(false);//不移除分词的词典
		tag.setDictionary(new Dictionary("./models/dict_pos.txt"), false);//设置POS词典，分词使用原来设置
		...
		POSTagger tag3 = new POSTagger("./models/pos.m", new Dictionary("./models/dict_pos.txt"));
